...
func TestTunnelAddr(t *testing.T) {
	...
	t.Run("should use PublicAddr with default ProxyWebPort if TLSRoutingEnabled was enabled", testTunnelAddr(testCase{
		...
		expectedTunnelAddr: "public.example.com:3080",
	}))
